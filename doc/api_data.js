define({ "api": [
  ...
  },
  {
      ...
      "fields": {
        "Success 200": [
          ...
          },
          {
            ...
            "optional": false,
            "field": "msg",
            "description": "<p><code>Refresh token successfully!</code> if everything went fine.</p>"
          },
          {
            "group": "Success 200",
            "type": "String",
    ...
    "sampleRequest": [
      {
        "url": "http://127.0.0.1:3000/api/v1/auth/token"
      }
    ]
  },
  {
      ...
      "fields": {
        "Success 200": [
          ...
          },
          {
            ...
            "optional": false,
            "field": "refreshToken",
            "description": "<p><code> Refresh token of user </code></p>"
          },
          {
            "group": "Success 200",
            "type": "Array[Int]",
  ...
  },
  {
    ...
    "sampleRequest": [
      {
        "url": "http://127.0.0.1:3000/api/v1/feedbacks/reply/:feedbackId"
      }
    ]
  },
  {
      ...
      "fields": {
        "Parameter": [
          ...
          },
          {
            ...
            "optional": false,
            "field": "isIdle",
            "description": "<p>shipper's status 1-true 0-false</p>"
          }
        ]
      }
    },
