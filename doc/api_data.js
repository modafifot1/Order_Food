define({ "api": [
        ...
        "Parameter": [
          {
            ...
            "optional": false,
            "field": "key-_itemId",
            "description": "<p>, value-quantity</p>"
          }
        ]
      },
      "examples": [
  ...
  {
    "type": "get",
    "url": "/api/v1/orders?statusId=",
    "title": "Get list order by userId and statusId",
    "name": "Get_list_order_by_userId_and_statusId",
    "group": "Order",
    "header": {
      "fields": {
        "Header": [
    ...
    "sampleRequest": [
      {
        "url": "http://127.0.0.1:3000/api/v1/orders?statusId="
      }
    ]
  },
  {
